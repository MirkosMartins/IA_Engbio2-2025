...
def build_decision_tree():
    ...
    # Salvar modelo
    joblib.dump(final_model, '/home/ubuntu/decision_tree_model.pkl')
...
def create_visualizations(model, y_pred, y_test, feature_names, feature_importance):
    ...
    plt.savefig('/home/ubuntu/decision_tree_visualization.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_text_tree(model, feature_names):
    ...
    with open('/home/ubuntu/decision_tree_text.txt', 'w') as f:
