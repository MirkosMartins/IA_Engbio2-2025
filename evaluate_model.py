...
def load_data_and_model():
    ...
    model = joblib.load('/home/ubuntu/decision_tree_model.pkl')
...
def create_advanced_visualizations(metrics):
    ...
    plt.tight_layout()
    plt.savefig('/home/ubuntu/evaluation_dashboard.png', dpi=300, bbox_inches='tight')
    plt.close()
...
"""
    ...
    with open('/home/ubuntu/evaluation_report.txt', 'w') as f:
        f.write(report)
